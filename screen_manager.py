...
class Display:
    ...
    def __init__(self, map_object: Map):
        ...
        # Loading images
        self.person_image = pygame.image.load(Consts.PERSON_IMAGE)
        self.person_image = pygame.transform.scale(self.person_image, (cell_size, cell_size))
    ...
    def update(self, state: State, save=False):
        self.draw_cells()
        person_y, person_x = state.person
        self.draw_in_position(person_y, person_x, self.person_image)
